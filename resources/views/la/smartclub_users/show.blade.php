...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $smartclub_user->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("SmartClub_Users", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/smartclub_users/'.$smartclub_user->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("SmartClub_Users", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.smartclub_users.destroy', $smartclub_user->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/smartclub_users') }}" data-toggle="tooltip" data-placement="right" title="Back to SmartClub Users"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'pib')
						@la_display($module, 'user_type')
						@la_display($module, 'address')
						@la_display($module, 'member_from')
					</div>
				</div>
			</div>
		</div>
