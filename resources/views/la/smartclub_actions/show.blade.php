...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $smartclub_action->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("SmartClub_Actions", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/smartclub_actions/'.$smartclub_action->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("SmartClub_Actions", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.smartclub_actions.destroy', $smartclub_action->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/smartclub_actions') }}" data-toggle="tooltip" data-placement="right" title="Back to SmartClub Actions"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'action_name')
						@la_display($module, 'action_from')
						@la_display($module, 'action_end')
						@la_display($module, 'action_description')
					</div>
				</div>
			</div>
		</div>
